 ...
 */
public class OdeProcessBundleUndeployer implements ProcessBundleUndeployer<OdeProcessBundle> {
	...
	/* (non-Javadoc)
	 * @see com.google.code.qualitas.engines.api.deployment.ProcessBundleDeployer#deploy(com.google.code.qualitas.engines.api.core.ProcessBundle)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.qualitas.engines.api.deployment.ProcessBundleDeployer#isSupported(com.google.code.qualitas.engines.api.core.ProcessBundle)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.qualitas.engines.api.deployment.ProcessBundleDeployer#setDefaultDeploymentServiceEndpoint(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.qualitas.engines.api.deployment.ProcessBundleDeployer#setDeploymentServiceEndpoint(java.lang.String)
	 */
	@Override
